...
if [ -n "$unix" ]; then
  ...
  time $CXX $CXXFLAGS $1 -I . -I src/ -O3 -ObjC++ -L bin/ -ldl -o $APP -framework OpenGL -framework AppKit -framework OpenAL -mmacosx-version-min=10.7 -stdlib=libc++ -Wno-format
