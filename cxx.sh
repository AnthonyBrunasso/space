...
if [ -n "$unix" ]; then
  ...
  time $CXX -g $CXXFLAGS $1 -I . -I src/ -ObjC++ -L bin/ -ldl -o $APP -framework OpenGL -framework AppKit -framework OpenAL -mmacosx-version-min=10.14 -stdlib=libc++ -Wno-format
